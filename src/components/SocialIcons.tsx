...
const SocialIcons = () => {
    return (
        <div className={'w-full flex justify-items-start items-center gap-8 my-4'}>
            {/* GitHub */}
            <a href={'https://github.com/markstanl'} rel={'noopener noreferrer'} aria-label={"Visit Mark Stanley's GitHub"}>
                <svg xmlns="http://www.w3.org/2000/svg" width={32} height={32} viewBox="0 0 24 24" className={'hover:text-brand-acc transition-colors duration-300'}>
            ...
            {/* LinkedIn */}
            <a href={'https://www.linkedin.com/in/markstanl/'} rel={'noopener noreferrer'} aria-label={"Visit Mark Stanley's LinkedIn"}>
                <svg xmlns="http://www.w3.org/2000/svg" width={32} height={32} viewBox="0 0 24 24" className={'hover:text-brand-acc transition-colors duration-300'}>
            ...
            {/* HuggingFace */}
            <a href={'https://huggingface.co/markstanl'} rel={'noopener noreferrer'} aria-label={"Visit Mark Stanley's HuggingFace"}>
                <svg xmlns="http://www.w3.org/2000/svg" width={32} height={32} viewBox="0 0 32 32" className={'hover:text-brand-acc transition-colors duration-300'}>
                    <g fill="currentColor">
                        <path
