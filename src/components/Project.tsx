...
const Project: React.FC<ProjectProps> = ({project}) => {
    return (
        <div className={'w-96 h-full bg-brand-text text-brand-bg rounded-lg p-4 flex flex-col gap-4 justify-between'}>
            <div className={'flex flex-col gap-4'}>
                <div
                    className={'flex justify-items-start items-center w-auto gap-2 hover:text-brand-prim-dark hover:tracking-wide transition-all duration-300'}>
